  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-950 to-teal-700">
      ...
      <div className="max-w-md mx-auto px-4 pt-4 pb-6 space-y-6">
        <RsvpSection gameId={game.id} defaultName={defaultName} isFull={attendees.length >= game.people_needed}>
          {/* Attendees */}
        ...
        <div className="flex justify-center pt-4 pb-2">
          <svg className="w-10 h-10 text-emerald-500/30" viewBox="0 0 1200 1200" fill="currentColor">
            <path d="m600 1134.4c-147.28 0-267.1-119.81-267.1-267.1 0-147.28 119.81-267.1 267.1-267.1 147.28 0 267.1 119.81 267.1 267.1 0 147.28-119.81 267.1-267.1 267.1zm0-477.94c-116.25 0-210.84 94.594-210.84 210.84 0 116.25 94.594 210.84 210.84 210.84s210.84-94.594 210.84-210.84c0-116.25-94.594-210.84-210.84-210.84z"/>
            <path d="m637.5 867.28c0 50.016-75 50.016-75 0s75-50.016 75 0"/>
            <path d="m637.5 722.06c0 50.016-75 50.016-75 0 0-49.969 75-49.969 75 0"/>
            <path d="m499.4 822.42c0 50.016-75 50.016-75 0s75-50.016 75 0"/>
            <path d="m552.14 984.74c0 50.016-75 50.016-75 0 0-49.969 75-49.969 75 0"/>
            <path d="m722.86 984.74c0 50.016-75 50.016-75 0 0-49.969 75-49.969 75 0"/>
            <path d="m775.6 822.42c0 50.016-75 50.016-75 0s75-50.016 75 0"/>
          </svg>
        </div>
      </div>
    </div>
